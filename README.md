...
关于游戏制作:
- 目前是只有一个叫MVE的游戏, 不过现在很纠结该用什么做, 用gms2吧...没有面向对象, 而且商业需要付费, 月费40+呢, 还不包括安卓. 用godot吧... 游标卡尺和智能提示太那啥了, 用它的mono的话... 其实也还行.但是总感觉反射来反射去的, 而且没热重载, 还算行吧... 用XNA的话...倒是有个Nez引擎, 但是场景布置很难搞, 因为没有带场景编辑器, 难搞...

目前人状态:
- 很累, 但不知道累在哪
- 很想做好很多事情但是实力不允许
- 累, 还是累, 除了累还是累, 似乎休息完全没用
